...
Cómo aterrizar tu idea de negocio paso a paso</h3><br>
    ...
    <div class="evento">
      ...
      <div class="detalle">
        ...
        <p>Benjamín Carrasco - SERCOTEC</p>
      </div>
    </div>
    <div class="evento">
...
<p>Vanesa</p>
    ...
    <div class="evento">
      ...
      <div class="detalle">
        ...
        <p>SUNAT/CASO DE EXITO SACSMYPE</p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="timeline">
    ...
    <div class="evento">
      ...
      <div class="detalle">
        ...
        <p>Startup chile(luis rebolledo) - innovo(ALEX ORTEGA)</p>
      </div>
    </div>
    <div class="evento">
      <span class="hora">6:00 PM</span>
    ...
    <div class="evento">
      ...
      <div class="detalle">
        ...
        <p>Moderadora: Narda Cuadros cecilia zegarra, ricardo chang y diana mori</p>        
      </div>
    </div>
  </div>
</div>
  ...
  <div class="timeline">
    ...
    <div class="evento">
      ...
      <div class="detalle">
        ...
        <p>Andrea Dulanto y Alessandra Utec Ventures</p>
      </div>
    </div>
    <div class="evento">
...
Tendencias disruptivas hacia el 2030 en LatinoAmérica</h3><br>
        <p>moderador: alex. panelistas: Adolfo Palomino  y guillermo firmeasy</p>
      </div>
    </div>
    <div class="evento">
      <span class="hora">5:30 PM</span>
...
<p>jurado: joseph, andrea y adolfo palomino</p>
      </div>
    </div>
    <div class="evento">
      <span class="hora">6:00 PM</span>
...
<p>jurado: joseph, andrea y adolfo palomino</p>
    ...
    <div class="evento">
      ...
      <div class="detalle">
        ...
        <p>moderador:  carlos (xrai, Petclub, sprintia, Dommis)</p>
      </div>
    </div>
    <div class="evento">
      <span class="hora">7:00 PM</span>
  ...
  <div class="timeline">
    ...
    <div class="evento">
      ...
      <div class="detalle">
        ...
        <p>jurados: adolfo palomino, antonella</p>
      </div>
    </div>
    <div class="evento">
      <span class="hora">4:00 PM</span>
